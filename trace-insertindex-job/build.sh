...
echo "--- Starting Clean Build for InsertIndex ---"

echo "Cleaning previous build artifacts..."
rm -rf classes/*
rm -f trace-insertindex-job.jar
...
# 打包 JAR 文件
echo "Creating Job JAR (trace-insertindex-job.jar) ..."
jar cf trace-insertindex-job.jar -C classes .
...
# 检查 JAR 文件时间戳
echo "Build finished successfully: trace-insertindex-job.jar created at $(ls -l trace-insertindex-job.jar | awk '{print $6, $7, $8}')"
