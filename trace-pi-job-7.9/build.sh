...
# 打包 JAR 文件
echo "Creating Job JAR (trace-pi-job.jar) containing only job classes..."
jar cf trace-pi-job.jar -C classes .
...
# 检查 JAR 文件时间戳
echo "Build finished successfully: trace-pi-job.jar created at $(ls -l trace-pi-job.jar | awk '{print $6, $7, $8}')"
