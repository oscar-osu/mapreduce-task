...
echo "--- Starting Clean Build for Sort ---"

echo "Cleaning previous build artifacts..."
rm -rf classes/*
rm -f trace-sort-job.jar
...
# 打包 JAR 文件
echo "Creating Job JAR (trace-sort-job.jar) ..."
jar cf trace-sort-job.jar -C classes .
...
# 检查 JAR 文件时间戳
echo "Build finished successfully: trace-sort-job.jar created at $(ls -l trace-sort-job.jar | awk '{print $6, $7, $8}')"
